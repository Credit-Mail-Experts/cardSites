    ...
    <body>
        ...
        if (isset($_POST["CustomerNumberEditableTextBox"]) && strlen($_POST["CustomerNumberEditableTextBox"] > 0)) {
            ...
            if (mysql_num_rows($result) == 0) {
                header("Location: walkin-form.php?customerNumber=$customerNumber");
                exit;
            }
        ...
        <div id="content">
            ...
            <?php if (isset($employeeId)) { ?>
                ...
                <button id="logoutButton" onclick="window.location='logout.php'" style="float: right; margin-right: 30px; margin-top: 5px; width: 100px; height: 30px;">Logout</button>
            ...
            <section id="step-3">
                ...
                <br />
                <form id="CustomerLookupForm" name="CustomerLookupForm" action="walkin-form.php" method="post">
                    <fieldset>
                        ...
                        <p style="color: green;"><?php if (isset($customerNumberSuccess)) echo "Card $customerNumberSuccess successfully activated!" ?></p>
                        <p style="color: red;"><?php if (isset($duplicateLead)) echo "Lead for $customerNumber was a duplicate lead and was NOT parsed!" ?></p>
                        <label for="CustomerNumberEditableTextBox">Card Number:</label><input type="text" id="CustomerNumberEditableTextBox" name="CustomerNumberEditableTextBox" maxlength="64" value="<?php if (isset($customerNumber)) echo $customerNumber ?>" /><br/>
                ...
                <div class="<?php
                        if ((isset($doesNotTakeAppointments) && isset($doesNotTakeWarmTransfers)) || ($_SESSION['employeeId'] == "jdbyrider")) {
                            echo "hide";
                        }
                    ?>">
                    <br /><br />
                    <fieldset>
                        ...
                        if (isset($doesNotTakeWarmTransfers)) {
                            echo "<div class='hide'>";
                        }
                ...
                <br /><br />
                <form id="CustomerInformationForm" name="CustomerInformationForm" action="walkin-submit.php" method="post">
                    <fieldset>
                        ...
                        <div id="form-column-one">
                            ...
                            <div id="callerIdSeciton" <?php if ($_SESSION['employeeId'] == "jdbyrider") echo "hidden"; ?> >
                            ...
                            <!-- wrapper to hide appointments for JD Byrider -->
                            <div id="appointmentSection" <?php if ($_SESSION['employeeId'] == "jdbyrider") echo "hidden"; ?> >
                        ...
                        <div id="form-column-two">
                            ...
                            <div id="warmTransferSection" <?php if ($_SESSION['employeeId'] == "jdbyrider") echo "hidden"; ?> >
